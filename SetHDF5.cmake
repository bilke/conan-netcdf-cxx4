...
endforeach()
# set(HDF5_hdf5_LIBRARY ${HDF5_LIBRARIES} CACHE INTERNAL "")
set(HDF5_LIBRARIES ${HDF5_LIBRARIES} CACHE INTERNAL "")
set(HDF5_C_LIBRARIES ${HDF5_LIBRARIES} CACHE INTERNAL "")
message(STATUS "Found HDF5 ${ogs.tested_version.hdf5} via Conan: ${CONAN_HDF5_ROOT}, LIBS: ${HDF5_LIBRARIES}")